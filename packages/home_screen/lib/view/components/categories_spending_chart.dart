...
final class CategoriesSpendingChart extends StatelessWidget {
  ...
  static final _data = <MockChartCategoryData>[
    MockChartCategoryData(
      category: CategoryData.mockData[0],
      value: 1000,
    ),
    MockChartCategoryData(
      category: CategoryData.mockData[1],
      value: 750,
    ),
    MockChartCategoryData(
      category: CategoryData.mockData[2],
      value: 590,
    ),
    MockChartCategoryData(
      category: CategoryData.mockData[3],
      value: 299,
    ),
    MockChartCategoryData(
      category: CategoryData.mockData[4],
      value: 120,
    ),
  ];
