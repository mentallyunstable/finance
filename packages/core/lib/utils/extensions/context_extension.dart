...
extension ContextExtension on BuildContext {
  ...
  /// Get [DependenciesContainer] from the [DependenciesScope] inside widget tree.
  DependenciesContainer get dependencies => DependenciesScope.of(this);

  RepositoryDependencies get repositories => DependenciesScope.of(this).repositories;

  ServiceDependencies get services => DependenciesScope.of(this).services;
}
